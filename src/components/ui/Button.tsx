...
export function Button({
  ...
  const variants = {
    ...
    secondary:
      'bg-dark-hover text-white border border-dark-border hover:bg-[#303030] disabled:opacity-50',
    ghost: 'text-text-secondary hover:text-white hover:bg-dark-hover disabled:opacity-50',
